...
## 起因与内心：
  > 继[docker-arch-pyenv-jupyter](https://github.com/469138946ba5fa/docker-arch-pyenv-jupyter)项目的完成，突发奇想我还可以以此为模板，构建 resilio sync 服务，以实现色色的需求。 
  >
  > 于是我就大脑一热觉得这是个好主意，但小脑不是很认同，于是我任性了一把👍任由它萎缩，就开发了这个`docker-arch-resilio-sync`，查询了大量文档，也测试了各种编译版本。
  >
  > 这里需要感谢[resilio sync](https://www.resilio.com/)开发的同步工具，可以实现我同步色色的资源。
  >
  > 也感谢[Resilio, Inc.](https://github.com/bt-sync)开源代码，让我省了不少测试的时间。
  >
  > 关于过去，我依旧且仍然没能释怀，那些糟糕的烂人成了我痛苦回忆的一部分，一直让我痛苦，很痛苦，我不能原谅那些人，我一辈子也原谅不了，也不知道要到什么时候才能解脱 =_= 😮‍💨
